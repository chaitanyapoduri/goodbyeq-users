...
public class ItemsController extends BaseController{
	...
	public @ResponseBody JSendResponse<String> createBill(@RequestBody String scannedItemsString, 
			HttpServletRequest request, HttpServletResponse response) 
			throws GoodByeQClientValidationException, GoodByeQCompanyServiceException {
